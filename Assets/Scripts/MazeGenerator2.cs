...
public class MazeGenerator : MonoBehaviour
{
    ...
    public void GenerateNewRandomMaze()
    {
        ...
        for (int x = 0; x < _mazeWidth; x++)
        {
            ...
            {
                _mazeGrid[x, y] = Wall;
                _mazeStructure[x, y] = Instantiate(_wallPrefab, new Vector3(x * _separation, 0f, y * _separation), Quaternion.identity, GetComponent<Transform>());
            }
        }
